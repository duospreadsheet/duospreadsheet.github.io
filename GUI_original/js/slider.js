...
Slider.prototype.installClickHandleText = function() {};
...
function initSliderDensityPlot() {
	...
	let svgTop = sliderPosition.top + sliderTrackPosition.top - ruleInputBoxMenuRangeContentSVGHeight - sliderTrackHeight / 2 + 1;
	...
	self.densityPlot.height = ruleInputBoxMenuRangeContentSVGHeight;
}
