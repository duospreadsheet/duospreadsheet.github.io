const TextGenerator = {
	generateCompareOneAndOneQuestionHTML: function(topShelfGroup, bottomShelfGroup) {
		const self = this;
		let topGroupNameHTML = '<div class="top-group-name group-or-attribute">' + self.generateGroupNameHTML(topShelfGroup) + '</div>';
		let bottomGroupNameHTML = '<div class="bottom-group-name group-or-attribute">' + self.generateGroupNameHTML(bottomShelfGroup) + '</div>';
	...
	generateCompareAttrOfOneAndOneQuestionHTML: function(topShelfGroup, bottomShelfGroup, attributeList) {
		...
		let topGroupNameHTML = '<div class="top-group-name group-or-attribute">' + self.generateGroupNameHTML(topShelfGroup) + '</div>';
		let bottomGroupNameHTML = '<div class="bottom-group-name group-or-attribute">' + self.generateGroupNameHTML(bottomShelfGroup) + '</div>';
		let attributeListHTML = '<div class="specified-attributes group-or-attribute">' + self.generateAttributeListString(attributeList) + '</div>';

		return topGroupNameHTML + bottomGroupNameHTML + attributeListHTML;
	},
	generateCompareOneAndManyQuestionHTML: function(topShelfGroup, firstBottomShelfGroup, secondBottomShelfGroup) {
		const self = this;
		let topGroupNameHTML = '<div class="top-group-name group-or-attribute">' + self.generateGroupNameHTML(topShelfGroup) + '</div>';
		let firstBottomGroupHTML = '<div class="bottom-group-name group-or-attribute">' + self.generateGroupNameHTML(firstBottomShelfGroup) + '</div>';
		let secondBottomGroupHTML = '<div class="bottom-group-name group-or-attribute">' + self.generateGroupNameHTML(secondBottomShelfGroup) + '</div>';

		return topGroupNameHTML + firstBottomGroupHTML + secondBottomGroupHTML;
	},
	generateCompareAttrOfOneAndManyQuestionHTML: function(topShelfGroup, firstBottomShelfGroup, secondBottomShelfGroup, attributeList) {
		const self = this;
		let topGroupNameHTML = '<div class="top-group-name group-or-attribute">' + self.generateGroupNameHTML(topShelfGroup) + '</div>';
		let firstBottomGroupHTML = '<div class="bottom-group-name group-or-attribute">' + self.generateGroupNameHTML(firstBottomShelfGroup) + '</div>';
		let secondBottomGroupHTML = '<div class="bottom-group-name group-or-attribute">' + self.generateGroupNameHTML(secondBottomShelfGroup) + '</div>';
		...
		return topGroupNameHTML + firstBottomGroupHTML + secondBottomGroupHTML + attributeListHTML;
	},
