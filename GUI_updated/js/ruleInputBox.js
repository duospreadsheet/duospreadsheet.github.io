const RuleInputBox = {
	...
	show: function(shelfType, top, left) {
		...
		if (shelfType == 'top') {
			...
			RuleInputBoxCategoricalMenu.AttributeNameSearchBox.focus();
			...
			RuleInputBoxTab.show();
			RuleInputBoxTab.changeColour(shelfType);
			RuleInputBoxTab.clearRules();
			RuleInputBoxTab.setActive('base');
		}
		if (shelfType == 'bottom') {
			RuleInputBoxCategoricalMenu.show();
			RuleInputBoxCategoricalMenu.AttributeNameList.display(scrollTop = 0);
		...
		if (shelfType == 'attribute') {
			...
			RuleInputBoxAttributeMenu.AttributeNameSearchBox.focus();
			RuleInputBoxInputInputBox.Rule.clear();
			RuleInputBoxInputInputBox.saveSpanEl({}); // remove all
			RuleInputBoxTab.hide();
		}
