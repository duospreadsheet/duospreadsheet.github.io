...
const sidebarResultPanelQuestionContentMaxHeight = 150;
...
// rule input box
const ruleInputBoxWidth = sidebarWidth - 2;

const ruleInputBoxInputBoxWidth = 'calc(100% - 19px)';
const ruleInputBoxInputBoxRuleContainerWidth = 'calc(100% - 38px)';

const ruleInputBoxMenuWidth = 'calc(100% - 19px)';
const ruleInputBoxMenuHeaderHeight = 25;
const ruleInputBoxMenuContentHeight = 70;
const ruleInputBoxMenuSearchBoxInputHeight = 'calc(100% - 2px - 4px)';
const ruleInputBoxMenuSearchBoxInputWidth = 'calc(100% - 40px - 2px)';

const ruleInputBoxMenuAttributeContentContainerWidth = 'calc(100% - 20px)';
const ruleInputBoxMenuAttributeContentContainerHeight = 70;
const ruleInputBoxMenuAttributeContentContainerDummyHeight = 'calc(100% - 6px)';
const ruleInputBoxMenuAttributeSearchBoxHeight = 20;

const ruleInputBoxMenuValueContentContainerWidth = 'calc(100% - 20px)';
const ruleInputBoxMenuValueContentContainerHeight = 70;

const ruleInputBoxMenuRangeContentSliderWidth = 'calc(100% - 70px)';
const ruleInputBoxMenuRangeContentSVGHeight = 20;
...
$(function() {
	...
	$('#sidebar .result-panel .question.content')
		...
		.css('max-height', sidebarResultPanelQuestionContentMaxHeight);
	...
	// rule input box
	$('#rule-input-box')
		.css('width', ruleInputBoxWidth);
	$('#rule-input-box .input-box')
		.css('width', ruleInputBoxInputBoxWidth);
	$('#rule-input-box .input-box .rule-container')
		.css('width', ruleInputBoxInputBoxRuleContainerWidth);
	$('#rule-input-box .menu')
		.css('width', ruleInputBoxMenuWidth);
	$('#rule-input-box .menu .header')
		.css('width', full)
		.css('height', ruleInputBoxMenuHeaderHeight);
	$('#rule-input-box .menu .content')
		.css('width', full)
		.css('height', ruleInputBoxMenuContentHeight);
	$('#rule-input-box .menu .search-box')
		.css('width', full)
		.css('height', ruleInputBoxMenuAttributeSearchBoxHeight);
	$('#rule-input-box .menu .search-box input')
		.css('width', ruleInputBoxMenuSearchBoxInputWidth)
		.css('height', ruleInputBoxMenuSearchBoxInputHeight);

	$('#rule-input-box .menu .attribute.content .container')
		.css('width', ruleInputBoxMenuAttributeContentContainerWidth)
		.css('height', ruleInputBoxMenuAttributeContentContainerHeight);
	$('#rule-input-box .menu .attribute.content .container .dummy')
		.css('width', full)
		.css('height', ruleInputBoxMenuAttributeContentContainerDummyHeight);

	$('#rule-input-box .menu .value.content .container')
		.css('width', ruleInputBoxMenuValueContentContainerWidth)
		.css('height', ruleInputBoxMenuValueContentContainerHeight);

	$('#rule-input-box .menu .range.content #rule-input-slider')
		.css('width', ruleInputBoxMenuRangeContentSliderWidth);
	$('#rule-input-box .menu .range.content svg')
		.css('height', ruleInputBoxMenuRangeContentSVGHeight);
	...
	Table.init();
	Data.loadFromPath('csv/colleges.csv');
	RuleInputBox.init();
	ShelfGroup.init();
	GroupEditor.init();
	FilterMenu.init();
